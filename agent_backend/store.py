...
class RedisTaskStore:
    """Task metadata, log stream (XRANGE replay), and PubSub fan-out."""
    ...
    async def ensure_consumer_group(
        ...
        try:
            await self.r.xgroup_create(stream_key, group, id="0", mkstream=True)
    ...
    async def ack_task(self, stream_key: str, group: str, msg_id: str) -> None:
        await self.r.xack(stream_key, group, msg_id)
